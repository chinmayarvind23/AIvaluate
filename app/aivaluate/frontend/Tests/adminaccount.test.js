...
describe('Selenium Admin Account Page Test', () => {
  ...
  test('Admin Account page loads and displays account details', async () => {
    try {
      ...
      // Wait for redirection to the admin account page
      await driver.wait(until.urlContains('/admin/account'), 20000);
      ...
      const accountIdField = await driver.wait(until.elementLocated(By.xpath('//div[contains(text(), "ID")]/following-sibling::div')), 20000);
