...
const ForgotPasswordEval = () => {
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5173/eval-api/forgotpassword', { email });
      ...
      <div className="auth-container">
        <div className="auth-form secondary-colorbg">
          ...
          <form onSubmit={handleForgotPassword}>
            ...
            <a href="/eval/login" className="back-to-login primary-color-text">Back to login</a>
          </form>
        </div>
      </div>
    </div>
...
export default ForgotPasswordEval;