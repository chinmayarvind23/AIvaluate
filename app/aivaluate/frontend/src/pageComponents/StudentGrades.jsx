...
const StudentGrades = () => {
    ...
    const grades = [
        { name: 'IP and Licensing', due: 'May 19 by 11:59p.m.', submitted: true, score: '10/10' },
        { name: 'Individual 1', due: 'May 19 by 11:59p.m.', submitted: true, score: '9/10' },
        { name: 'Individual 2', due: 'May 20 by 11:59p.m.', submitted: false, score: '0/10' },
        { name: 'Lab 1', due: 'May 20 by 11:59p.m.', submitted: true, score: '7.5/10' },
        { name: 'Lab 2', due: 'May 31 by 11:59p.m.', submitted: true, score: '25/25' },
    ];
    const studentName = 'Colton';
    const totalGrade = 79.2;
    return (
        <div>
                ...
                <table className="grades-table secondary-colorbg">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="total fourth-colorbg">{totalGrade}%</td>
                        </tr>
                    </tbody>
                </table>
            </div>
