...
describe('Selenium Forgot Password Page Test', () => {
  ...
  test('Forgot Password page loads and submits form', async () => {
    try {
      await driver.get('http://localhost:5173/eval/forgotpassword');

      // Debugging: Log to check if the page loaded
      console.log('Navigated to /eval/forgotpassword');
      ...
      await confirmEmailInput.sendKeys('testprof@email.com');
